...
function switchMirror(){
	if(window.repo=='http://23.83.237.166/')
	{window.repo='http://ulti-repo.eterea.uk/'}
	else{window.repo='http://23.83.237.166/'}
...
function getPathUsingDialog(){
	...
	var path = dialog.showOpenDialog({
		...
		if(value.filePaths.length==0){document.getElementById('blocker').style.visibility='visible';return;}
